import { WorkCategory, Subcategory, Work } from './constants';
...
export const WORK_CATEGORIES: { [key: string]: string[] } = {
  ...
  [WorkCategory.electronic]: ['6575f2f4-46e1-47ea-8478-a156e45cd84c'],
};
...
export const WORK_SUBCATEGORIES: { [key: string]: Subcategory } = {
  ...
  '333dbd32-ce3e-4bd7-b782-e417a89ffcd4': {
    ...
    works: ['ea5b7981-ec00-4aeb-82d4-34857211eda2'],
  },
  'e03a369f-edc4-4cf3-b004-89649adc0f7d': {
    title: 'Other',
    works: ['a8e535ed-a871-4ccb-9387-b42f807ec0f1'],
  },
  '317d3b33-c8ba-4b93-9163-a5a2ed25181a': {
    title: 'Brass Quintet',
    works: ['0a5c98bc-cfaa-4b46-8f24-7830ca8a7a40'],
  },
  '7d8c580d-1fac-4291-a841-cff62224b491': {
    title: 'Solo Piano',
    works: [
  ...
  'bdc1070a-f3cb-4392-847d-1747b35fbbaa': {
    title: 'Solo Flute',
    works: ['1eac0a9e-64bb-42c2-9113-6e62e1a026b7', 'ef351b0b-7f8d-4c95-b955-6b9f54b88a14'],
  },
  '6a9ef52e-edcd-4207-b9ed-946c55d8cd00': {
    title: 'Other',
    works: [
  ...
  '4a1a6d47-f9c3-4a38-80d3-1521befb57a5': {
    ...
    works: ['2b75d209-5efb-480f-a990-5a4a80b49089', 'cc42740b-3302-4a16-aca1-df1c130f0419'],
  },
  '474bed9f-a95d-42ce-b4d6-afa6e02a2ae7': {
  ...
  '3a39d84b-649e-427d-bd13-cca993013192': {
    title: 'Trailers',
    works: ['f5e0ed44-d4b1-4e74-8312-6b5a42fd76a8'],
  },
  '6575f2f4-46e1-47ea-8478-a156e45cd84c': {
    works: ['c8665715-aca1-4839-8559-c8701eaa2372', '643837c3-3065-4b55-94e9-491777e08872'],
  },
};
